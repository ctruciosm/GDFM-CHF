function [parameters, ll ,Ht, Qt,intercept,stdData]=dcc_normal(data,dataAsym,m,l,n,p,o,q,gjrType,method,composite,startingVals,options)
...
% parameters, ll ,Ht, Qt,intercept,stdData
% USAGE:
...
isJoint = true;
isInference = true;
[ll,~,Rt,Qt,intercept,stdData] = dcc_likelihood_eval(parameters,data,dataAsym,m,l,n,[],[],backCast,backCastAsym,stage,composite,isJoint,isInference,gScale,univariate);
ll = -ll;
Ht = zeros(k,k,T);
for t=1:T
    h = sqrt(H(t,:));
