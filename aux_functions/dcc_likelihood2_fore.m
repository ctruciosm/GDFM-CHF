function [ll,lls,Rt] = dcc_likelihood2_fore(parameters,data,m,n,R,N,backCast,stage,composite,isJoint,isInference,gScale,univariate)
...
H = ones(T,k);  
if computeVol
    H = dcc_reconstruct_variance_fore(garchParameters,univariate);          % _fore
    for t=1:T    
        h = sqrt(H(t,:));
