function [parameters,ht,w,pc,htMat]=o_mvgarch2(data,numfactors,p,o,q,startingVals,options)
% Estimates a multivariate GARCH model using Orthogonal or Factor Garch.  Involves Principal Component
% Analysis to reduce volatility modelling to univariate garchs.  See Carol 2000 (An Inrtoduction to O-Garch)
%
% USAGE:
