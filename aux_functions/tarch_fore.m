function [parameters, LL, ht, VCVrobust, VCV, scores, diagnostics] = tarch_fore(epsilon, p, o, q, error_type, tarch_type, startingvals, options)
...
if nargout>1
    epsilon_augmented = [epsilon_augmented; 0];                             % 0 was added 
    [LL, ~, ht]=tarch_likelihood(parameters,epsilon_augmented,fepsilon,fIepsilon,p,o,q,error_type,tarch_type,back_cast,T+1);    % T changed by T+1
    LL=-LL;
end
